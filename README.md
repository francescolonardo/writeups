...
This repository contains writeups of machines I’ve completed on CTF platforms like <img src="./assets/logo_hackthebox.png" alt="HackTheBox Logo" height="16" style="width:auto"> **HackTheBox**, <img src="./assets/logo_hackmyvm.png" alt="HackMyVM Logo" height="16" style="width:auto"> **HackMyVM**, and <img src="./assets/logo_vulnyx.png" alt="VulNyx Logo" height="16" style="width:auto;"> **VulNyx**. It includes detailed steps for identifying vulnerabilities, exploiting them, and achieving privilege escalation or post-exploitation when applicable.
